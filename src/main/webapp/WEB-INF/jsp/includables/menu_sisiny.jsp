...
<!-- MENU SIDEBAR-->
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <img src="${pageContext.servletContext.contextPath}/admin/assets/images/icon/logo.png" alt="Nopacks" />
                </a>
            </div>
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="${lien=='news' ? 'active' : ''}" >
                            <a href="${pageContext.servletContext.contextPath}/admin/frais">
                                <i class="fas fa-table"></i>News</a>
                        </li>
