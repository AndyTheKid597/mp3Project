            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading white wow fadeInUp" data-wow-delay="100ms">
                        <p></p>
                        <h2>Details de la playlist: ${playlist.nom}</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="contact-form-area">
                        <form action="${pageContext.servletContext.contextPath}/site/ajouterDetailsPlaylist" method="POST">
                            <div class="row">
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group wow fadeInUp" data-wow-delay="100ms">
                                        <select  class="form-control" placeholder="Chanson" name="idchanson">
                                            <c:forEach items="${listechansons}" var="sg">
                                            <option value="${sg.id}" style="color:black;">${sg.titre}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                    <input type="hidden" name="id" value="${idpl}"/>
                                </div>
                                <div class="col-12 text-center wow fadeInUp" data-wow-delay="500ms">
                                    <button class="btn oneMusic-btn mt-30" type="submit">Ajouter la chanson <i class="fa fa-angle-double-right"></i></button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="single-event-area mb-30">
                        ...
                        <div class="event-text" style="height:190px;">
                            ...
                            <div class="event-meta-data">
                                <a href="${pageContext.servletContext.contextPath}/site/deleteDetailsPlaylist?id=${playlist.id}&idchanson=${sg.id}">Supprimer</a>
                            </div>
